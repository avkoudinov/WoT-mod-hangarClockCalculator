package  {
	...
	public class hangarClockAnalog extends AbstractView {

		public function hangarClockAnalog() {
			super();
			this.init();
		}
		...
		private var zClockAnalog:hClockAnalog = null;
